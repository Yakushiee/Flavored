...
public class RangeScreenHandler extends ScreenHandler {
    private final Inventory inventory;

    private final PropertyDelegate propertyDelegate;

    public RangeScreenHandler(int syncId, PlayerInventory playerInventory) {
    ...
    public RangeScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        super(FlavoredScreenHandlers.RANGE_SCREEN_HANDLER, syncId);
